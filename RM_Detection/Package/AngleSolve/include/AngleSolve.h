...
public:
    ...
    /** 四元数旋转矩阵 */
    Eigen::Matrix3d quaternionToRotationMatrix();               // 四元数转换为旋转矩阵
...
private:
    ...
    Eigen::Vector3d gimbal_offset_angle;                    // 抬升枪口角度补偿
    ...
    /** 旋转矩阵 */
    Eigen::Matrix3d EulerAngle2RotationMatrix(double pitch,double roll,double yaw);
