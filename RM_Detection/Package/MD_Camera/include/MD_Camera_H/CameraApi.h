...
/// \~english
/// \brief The MD_Camera_H is initialized. After successful initialization, other MD_Camera_H-related operation interfaces can be called.
/// \param [in] CameraName Camera friendly name.@link #tSdkCameraDevInfo.acFriendlyName @endlink
/// \param [out] pCameraHandle The handle pointer of the MD_Camera_H, after successful initialization, returns the MD_Camera_H's effective handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get MD_Camera_H exposure time range
/// \param [in] hCamera Camera handle.
...
/// \~english
/// \brief Set the multiple exposure time. The unit is microseconds. (This feature is only supported by line MD_Camera_H)
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the multiple exposure time. The unit is microseconds. (This feature is only supported by line MD_Camera_H)
/// \param [in] hCamera Camera handle.
/// \param [in] index Exposure index.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the number of multiple exposure enable. (This feature is only supported by line MD_Camera_H)
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the number of multiple exposure enable. (This feature is only supported by line MD_Camera_H)
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the maximum number of exposures for multiple exposures. (This feature is only supported by line MD_Camera_H)
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the image gain magnification of the MD_Camera_H.
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the value range of the MD_Camera_H's gain magnification
/// \param [in] hCamera		Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the frame frequency (area) or line frequency (line scan). (only supported by some gige MD_Camera_H)
/// \param [in] hCamera Camera handle.
...
/// \~english
/// \brief Set the level state of the specified IO. IO is the output IO. The number of programmable output IOs for the MD_Camera_H is determined by @link #tSdkCameraCapbility.iOutputIoCounts @endlink.
/// \param [in] hCamera Camera handle.
...
/// \~english
/// \brief Read the level state of the specified IO. IO is the output IO. The number of programmable output IOs for the MD_Camera_H is determined by @link #tSdkCameraCapbility.iOutputIoCounts @endlink.
/// \param [in] hCamera Camera handle.
/// \param [in] iOutputIOIndex IO index, starting from 0.
...
/// \~english
/// \brief Read the level state of the specified IO, IO is input type IO, the number of programmable output IOs that the MD_Camera_H reserves is decided by @link #tSdkCameraCapbility.iInputIoCounts @endlink.
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the MD_Camera_H's LED enable status, without the LED's model, this function returns an error code indicating that it is not supported.
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the MD_Camera_H's LED enable status, without the LED's model, this function returns an error code indicating that it is not supported.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the MD_Camera_H's LED switch status, without the LED's model, this function returns an error code indicating that it is not supported.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the MD_Camera_H's LED switch status, without the LED model, this function returns an error code that does not support.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the MD_Camera_H's LED duration, without the LED model, this function returns an error code indicating that it is not supported.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the MD_Camera_H's LED duration, without the LED model, this function returns an error code indicating that it is not supported.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the MD_Camera_H's LED brightness, without the LED model, this function returns an error code indicating that it is not supported.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the MD_Camera_H's LED brightness, without the LED model, this function returns an error code that does not support.
/// \param [in] hCamera Camera handle.
/// \param [in] index The index of the LED, starting from 0. If there is only one LED that can control the brightness, this parameter is 0.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Do ISP for a certain monocular in the multi-MD_Camera_H frame.
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the output mode of the light controller (Smart MD_Camera_H series and hardware support required)
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the output status of the light controller (Smart MD_Camera_H series and hardware support required)
/// \param [in] hCamera Camera handle.
/// \param [in] index controller index
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief The ID of the current frame needs to be supported by the MD_Camera_H (supported by the full range of network ports). This function returns an error code indicating that it is not supported.
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Sets the callback notification function for MD_Camera_H connection state changes. When the MD_Camera_H is disconnected and reconnected, the callback function pointed to by pCallBack will be called.
/// \param [in] hCamera Camera handle.
...
/// \~english
/// \brief Enumerates GIGE devices from the specified IP and builds a device list (applicable when the MD_Camera_H and computer are not on the same network segment)
...
/// \note The list of returned MD_Camera_H information will be sorted according to acFriendlyName. For example, after changing the two cameras to the names of "Camera1" and "Camera2," the MD_Camera_H named "Camera1" will be in front, and the MD_Camera_H named "Camera2" will be behind the row.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Configure some options for the gige MD_Camera_H
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Get the GIGE MD_Camera_H's IP address
/// \param [in] pCameraInfo MD_Camera_H's device description information can be obtained by @link #CameraEnumerateDevice @endlink function.
/// \param [out] CamIp MD_Camera_H IP (Note: must ensure that the incoming buffer is greater than or equal to 16 bytes)
/// \param [out] CamMask MD_Camera_H subnet mask (Note: must ensure that the incoming buffer is greater than or equal to 16 bytes)
/// \param [out] CamGateWay MD_Camera_H gateway (Note: must ensure that the incoming buffer is greater than or equal to 16 bytes)
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Set the GIGE MD_Camera_H's IP address
/// \param [in] pCameraInfo MD_Camera_H's device description information can be obtained by @link #CameraEnumerateDevice @endlink function.
/// \param [in] Ip MD_Camera_H IP (eg 192.168.1.100)
/// \param [in] SubMask MD_Camera_H subnet mask (eg 255.255.255.0)
/// \param [in] GateWay Camera Gateway (eg 192.168.1.1)
/// \param [in] bPersistent TRUE: Set MD_Camera_H to fixed IP, FALSE: Set MD_Camera_H to assign IP automatically (ignoring parameters Ip, SubMask, GateWay)
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
...
/// \param [in] pCameraInfo MD_Camera_H's device description information can be obtained by @link #CameraEnumerateDevice @endlink function.
/// \param [out] CamMac MD_Camera_H MAC (Note: must ensure that the incoming buffer is greater than or equal to 18 bytes)
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Clear all cached frames in the MD_Camera_H
/// \param [in] hCamera Camera handle.
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief When the MD_Camera_H is in the trigger mode (soft trigger or hard trigger), the MD_Camera_H sends a frame to the PC. If the MD_Camera_H does not receive the reception confirmation from the PC, the MD_Camera_H can retransmit the frame several times. Use this function to set the number of MD_Camera_H resends. (only supported by Gige MD_Camera_H)
/// \param [in] hCamera Camera handle.
...
/// \return 成功返回 CAMERA_STATUS_SUCCESS(0)。否则返回非0值的错误码, 请参考 CameraStatus.h 中错误码的定义。
/// \~english
/// \brief Configure system options (usually required before CameraInit turns on the MD_Camera_H)
/// \param [in] optionName option name("NumBuffers", "3")
/// \param [in] value setting value
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
