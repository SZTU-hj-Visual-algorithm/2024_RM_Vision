...
//            AO.Center_fitting(Tracker.enemy_armor,0.23,0.1);
//            AO.World_projection_show();
//            if(AO.Fit_OK) AO.ArmorObserve_show(AO.Smooth_position);
            double angle = -50.5;
            double dis = AO.World_projection(Tracker.enemy_armor,angle);
//            std::cout << dis << std::endl;
            ...
            while (r-l >= eps) {
                ...
                double ls_dis = AO.World_projection(Tracker.enemy_armor,ls);
                double rs_dis = AO.World_projection(Tracker.enemy_armor,rs);
                if(ls_dis > rs_dis) {
                    l = ls;
                }
                else {
...
//            std::cout << l << "  " << r << std::endl;
            std::cout << AO.World_projection(Tracker.enemy_armor,l) << "    "
                     << AO.World_projection(Tracker.enemy_armor,-l) << std::endl;
            if(AO.World_projection(Tracker.enemy_armor,l) > AO.World_projection(Tracker.enemy_armor,-l))
                l = -l;
