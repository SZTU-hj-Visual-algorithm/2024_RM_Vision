...
public:
    ...
    //========================API接口=======================
    void Center_fitting(Armor &armor,double axes_length);                       // 拟合圆心位置
...
private:
    ...
    //========================函数部分=======================
    /** 拟合函数 */
    double Orientation_angle_fitting(double x);         // 求装甲板朝向角
