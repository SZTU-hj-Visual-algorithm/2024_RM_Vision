...
#ifndef RM_DETECTION_ORDER_KALMAN_H
#define RM_DETECTION_ORDER_KALMAN_H
...
public:
    ...
    void setPosAndSpeed(float position,float speed);            // 设置点和速度
    Eigen::Matrix<double, 2, 1> predict();                      // 更新步
    Eigen::Matrix<double, 2, 1> update(float z_k);              // 预测步
    ...
    Eigen::Matrix<double, 2, 1> x_post;                         // 校正矩阵
};


#endif //RM_DETECTION_ORDER_KALMAN_H
